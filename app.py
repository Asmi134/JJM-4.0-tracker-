...
def add_project(project_name, year, jjm_strategic_pillars, target_main_category,
    ...
    try:
        # Get a fresh connection/cursor to avoid any stale connection issues
        conn = get_db_connection()
        cursor = conn.cursor()
    ...
    if choice == "Manage Departments":
        ...
        if add_project_button:
            ...
            if success:
                ...
                st.error("Failed to add project. Please check the database connection.")
            ...
            if selected_upd:
                ...
                if st.button("Update Project Details"):
                    ...
                    if success:
                        ...
                        st.error("Failed to update project. Please check the database connection.")
        else:
